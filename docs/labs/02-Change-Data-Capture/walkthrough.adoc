...
. At this point if all configuration is correct, you will be able to see messages in the moon cluster.
+
[source,bash,subs="attributes+"]
----
oc rsh moon-kafka-0
...
----
The next section is about REST enabling access to the moon topic.
