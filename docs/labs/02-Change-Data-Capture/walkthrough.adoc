...
. Go back, or Open a new tab with the OpenShift Developer Console link:{openshift-host}/topology{namespace}[Topology View, window="_blank"].
+
[IMPORTANT]
====
Be sure to be in your _{namespace}_ project
====
...
[source,bash,subs="attributes+"]
----
oc expose service debezium-connect-api --name kafka-connect {namespace}
----
+
[IMPORTANT]
====
...
[source,bash,subs="attributes+"]
----
oc expose service http-bridge-service --name kafka-bridge {namespace}
----
