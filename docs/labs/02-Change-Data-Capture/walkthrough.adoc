...
*Congratulations!* You just finishied capturing data from a MSSQL database into Kafka to then, replicate that information to a different Kafka cluster. Finally you were able to retrieve the information using HTTP commands.
