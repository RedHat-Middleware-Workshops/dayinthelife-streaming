...
In this lab you replay streams of event to see the possible analytical result of farm costs in order to better predict revenue. This is a common appoarch as one of event streaming technique-- Event sourcing. You have been introduced to implemented with ease with Camel-K and Red Hat Streams. 
