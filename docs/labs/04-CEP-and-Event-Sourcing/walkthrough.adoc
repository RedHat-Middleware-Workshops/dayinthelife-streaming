...
[source,bash,subs="attributes+"]
----
kamel run --name edge-simulator EdgeSimulator.java
----
...
. Go to the *FleurDeLune/projects/harvest/simulator* folder, find *EdgeSimulator.java* and update the  MIN from 150 to 1;
+
[source,bash,subs="attributes+"]
----
...
[source,bash,subs="attributes+"]
----
cd $CHE_PROJECTS_ROOT/{lab-path}/harvest/simulator
