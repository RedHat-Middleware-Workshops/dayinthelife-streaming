...
(Skip this part and go directly to the *Create a Topic* section if you have already done so in other labs.)
...
(Skip this part and go directly to the *Setup Order Inventory with AMQ Streams* section if you have already done so in other labs.)
