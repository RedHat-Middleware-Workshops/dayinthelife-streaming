...
:amq-url: https://console-workshop-operators.{openshift-app-host}/
...
.AMQ
****
* link:{amq-url}/[Open AMQ Online, window="_blank"]
****
...
. Navigate to the AMQ Online console: {amq-url}[AMQ Online, window="_blank", id="{context}-3"].
