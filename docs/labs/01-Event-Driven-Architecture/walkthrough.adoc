...
****
* link:{openshift-host}/k8s/ns/{namespace}/operators.coreos.com~v1alpha1~ClusterServiceVersion/amq-online.1.5.2/enmasse.io~v1beta1~AddressSpace[AMQ Operator view, window="_blank"]
****
...
[source,none,subs="attributes+"]
----
oc apply -n {namespace} -f $CHE_PROJECTS_ROOT/FleurDeLune/support/projects/module-1/eda-services.yaml
----
