...
. Go to the factories on the top right, choose dilii, it will take you to the factory setting page.
...
. In your workspace, open StreamingLife/eventdriven/OrderService.java by double click on it. 
. Update the BROKER_URL with your new addressspace service url
