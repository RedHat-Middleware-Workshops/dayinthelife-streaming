...
.Fuse Online
****
* link:{fuse-url}[Fuse Online Console]
****
...
. Get back to the link:{fuse-url}[Fuse Online Console]
...
. Let's get the *inventory* service back online. Get back to the link:{fuse-url}[Fuse Online Console]
