...
[source,bash,subs="attributes+"]
----
oc -n {user-username} new-app events -l 'app.openshift.io/runtime=quarkus,app.kubernetes.io/part-of=event-driven'; oc expose svc/events -n {user-username}
----
