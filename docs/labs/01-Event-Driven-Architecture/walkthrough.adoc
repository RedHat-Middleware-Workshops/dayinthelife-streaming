...
[source,none,subs="attributes+"]
----
oc -n {namespace} create configmap amqp-properties --from-file $PROJECTS_ROOT/fleur-de-lune/support/projects/module-1/application.properties
----
...
. In the same OpenShift Dev Spaces terminal issue the following command:
+
[source,bash,subs="attributes+"]
----
