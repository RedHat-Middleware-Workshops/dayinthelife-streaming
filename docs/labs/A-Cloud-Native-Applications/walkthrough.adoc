...
****
* link:{openshift-host}/topology/{namespace}[Topology View, window="_blank"]
****
...
. Open the OpenShift Developer Console link:{openshift-host}/topology/{namespace}[Topology View, window="_blank"], make sure it's done deploying by waiting for the dark blue circles around the OpenShift logo:
+
